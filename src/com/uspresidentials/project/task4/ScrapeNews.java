...
public class ScrapeNews {
	...
	private static String LINK_STRING ="https://www.google.com/search?hl=en&gl=us&tbm=nws&authuser=0&q=hillary+clinton&oq=hillary+clinton&gs_l=news-cc.3..43j0l9j43i53.324553.326534.0.328574.15.7.0.8.8.0.130.603.5j2.7.0...0.0...1ac.1.QU4duoZIL4M#q=hillary+clinton&safe=off&hl=en&gl=us&authuser=0&tbm=nws&start="+number;
	...
	public static void scrapeNewsFromGoole(String linkString){
		...
		for (int i = 0; i <=300 ; i=i+10) {
			...
			if(!firstTime){
				...
				LINK_STRING ="https://www.google.com/search?hl=en&gl=us&tbm=nws&authuser=0&q=hillary+clinton&oq=hillary+clinton&gs_l=news-cc.3..43j0l9j43i53.324553.326534.0.328574.15.7.0.8.8.0.130.603.5j2.7.0...0.0...1ac.1.QU4duoZIL4M#q=hillary+clinton&safe=off&hl=en&gl=us&authuser=0&tbm=nws&start="+number;
			}
			try {
				doc = Jsoup.connect(LINK_STRING).userAgent("Mozilla").get();
